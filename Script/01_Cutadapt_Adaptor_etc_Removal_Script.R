...
#                           "-m", 1,
#                           "-o", fnFs.cut_adaptor[5], "-p", fnRs.cut_adaptor[5], # output files
#                           fnFs.filtN[5], fnRs.filtN[5])) # input files
...
#system2(cutadapt, args = c(R1.flags, R2.flags, "-n", 2, # -n 2 required to remove FWD and REV from reads
#                           "-m", 1,
#                           "-o", fnFs.cut_primer[5], "-p", fnRs.cut_primer[5], # output files
#                           fnFs.cut_adaptor[5], fnRs.cut_adaptor[5])) # input files
...
# Removing pad and linker third and last
